...
const N_AIR: f32 = 1.0;
const N_CORNEA: f32 = 1.64099928591927;
const N_ANTERIOR_CHAMBER: f32 = 1.4532300393624265;
const N_LENS: f32 = 1.4393602250536033;
const N_VITREOUS_HUMOUR: f32 = 1.362681339093861;

const OUTER_CORNEA_RADIUS: f32 = 7.873471062713062;
const INNER_CORNEA_RADIUS: f32 = 4.7658074271207695;
const VITREOUS_HUMOUR_RADIUS: f32 = 11.704040541034434;

const OUTER_CORNEA_CENTER: vec3<f32> = vec3<f32>(0., 0., 6.673155500500702);
const INNER_CORNEA_CENTER: vec3<f32> = vec3<f32>(0., 0., 7.877094062114152);
const VITREOUS_HUMOUR_CENTER: vec3<f32> = vec3<f32>(0., 0., 0.0);

const OUTER_LENS_RADIUS_A: f32 = 5.0719602142230795E-11;
const OUTER_LENS_RADIUS_B: f32 = -4.728025830060936E-6;
const OUTER_LENS_RADIUS_C: f32 = 8.768369917723753;
const INNER_LENS_RADIUS_A: f32 = 1.8872104415414247E-11;
const INNER_LENS_RADIUS_B: f32 = 1.3008349405807643E-5;
const INNER_LENS_RADIUS_C: f32 = 7.237406273489772;

const OUTER_LENS_TIP_A: f32 = -3.867155451878399E-11;
const OUTER_LENS_TIP_B: f32 = 1.5465450056679198E-7;
const OUTER_LENS_TIP_C: f32 = 8.839055805878198;
const INNER_LENS_TIP_A: f32 = -8.525281533727847E-12;
const INNER_LENS_TIP_B: f32 = 3.777299048943033E-6;
const INNER_LENS_TIP_C: f32 = 7.03207918882336;
